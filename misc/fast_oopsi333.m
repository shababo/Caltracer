...
if ~isfield(P,'gam'),   P.gam   = (1-V.dt/.8)*ones(V.Ncells,1);  end  %default was 1 instead of .8
if ~isfield(P,'lam'),   P.lam   = 1*ones(V.Ncells,1);          end  %default was 10 instead of 1
