...
%this function will calculate the time between each event and its next
%closest event in another cell during an UPstate. 
%data should first be imported from excel and organized into the workspace
%into data structures, the name of which corresponds to the expt name and
%recording. 
