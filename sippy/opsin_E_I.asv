...
for n = 1:number_trials
    amp_ns_EPSP(n,:) = all_amps_EPSP{n, no_shutter};
    amp_s_EPSP(n,:) = all_amps_EPSP{n, shutter};
    pp_ratios_ns_EPSP(n,:) = pp_ratios_EPSP{n, no_shutter};
    pp_ratios_s_EPSP(n,:) = pp_ratios_EPSP{n, shutter};
    ten_90_s_EPSP(n,:) = ten_90_all_EPSP{n, no_shutter};
    ten_90_ns_EPSP(n,:) = ten_90_all_EPSP{n, shutter};
    integral_ns_EPSP(n,:) = integral_all_EPSP{n, no_shutter};
    integral_s_EPSP(n,:) = integral_all_EPSP{n, shutter};
    amp_ns_IPSC(n,:) = all_amps_IPSC{n, no_shutter};
    amp_s_IPSC(n,:) = all_amps_IPSC{n, shutter};
    pp_ratios_ns_IPSC(n,:) = pp_ratios_IPSC{n, no_shutter};
    pp_ratios_s_IPSC(n,:) = pp_ratios_IPSC{n, shutter};
    ten_90_s_IPSC(n,:) = ten_90_all_IPSC{n, no_shutter};
    ten_90_ns_IPSC(n,:) = ten_90_all_IPSC{n, shutter};
    integral_ns_IPSC(n,:) = integral_all_IPSC{n, no_shutter};
    integral_s_IPSC(n,:) = integral_all_IPSC{n, shutter};
end
